...
import { Fragment, isRef, ref, computed, provide, inject, defineComponent as defineComponent$1, getCurrentInstance as getCurrentInstance$1, shallowReactive, toRaw, watchEffect, capitalize, camelize, h, watch, onBeforeUnmount, createVNode, mergeProps, Transition, onBeforeMount, nextTick, withDirectives, vShow, resolveDirective, toRef, resolveDynamicComponent, onMounted, unref, toRefs, reactive, TransitionGroup, vModelDynamic, createTextVNode, effectScope, onScopeDispose, warn, toHandlers, Teleport, readonly, onBeforeUpdate, vModelText } from 'vue';
...
const VImg = defineComponent({
  ...
  setup(props, _ref) {
    ...
    }, 8, ["class", "style", "aspectRatio", "aria-label", "role"]), [[resolveDirective("intersect"), {
      handler: init,
    ...
    return () => {
      ...
      return withDirectives(createVNode(Tag, {
        ...
        default: () => [genOverlays(true, 'v-btn'), !props.icon && props.prependIcon && createVNode(VIcon, {
          ...
          "left": !props.stacked
        }, null, 8, ["icon", "left"]), typeof props.icon === 'boolean' ? (_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots) : createVNode(VIcon, {
          "class": "v-btn__icon",
          "icon": props.icon,
          "size": props.size
        }, null, 8, ["icon", "size"]), !props.icon && props.appendIcon && createVNode(VIcon, {
          "class": "v-btn__icon",
    ...
    return () => {
      ...
      return createVNode(props.tag, {
        ...
        default: () => [props.image && createVNode(VImg, {
          "src": props.image,
          "alt": ""
        }, null, 8, ["src"]), props.icon && !props.image && createVNode(VIcon, {
          "icon": props.icon
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(props.tag, {
        ...
        default: () => [hasContent && createVNode(VBannerContent, null, {
          default: () => [hasAvatar && createVNode(VBannerAvatar, null, {
            default: () => [slots.avatar ? slots.avatar() : createVNode(VAvatar, {
              "density": props.density,
              "icon": props.icon,
              "image": props.avatar
          ...
          _: 1
        }), slots.actions && createVNode(VBannerActions, null, {
    ...
    return () => {
      ...
      return createVNode(props.tag, {
        ...
        default: () => [props.icon && createVNode(VIcon, {
          ...
          }, 16), index < props.items.length - 1 && createVNode(VBreadcrumbsDivider, null, {
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return withDirectives(createVNode(Tag, {
        ...
        default: () => [genOverlays(isClickable, 'v-card'), hasImage && createVNode(VCardImg, null, {
          ...
          default: () => [hasPrepend && createVNode(VCardAvatar, null, {
            default: () => [slots.prepend ? slots.prepend() : createVNode(VAvatar, {
              "density": props.density,
              "icon": props.prependIcon,
            ...
            _: 1
          }), hasAppend && createVNode(VCardAvatar, null, {
            default: () => [slots.append ? slots.append() : createVNode(VAvatar, {
              "density": props.density,
              "icon": props.appendIcon,
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(MaybeTransition, {
        ...
        default: () => [messages.value.length > 0 && props.active && messages.value.map((message, i) => createVNode("div", {
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "icon": props.prependIcon
      }, null, 8, ["icon"])], 8, ["onClick"]), (_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots, slotProps.value), hasAppend && createVNode("div", {
        ...
        "icon": props.appendIcon
      }, null, 8, ["icon"])], 8, ["onClick"]), hasDetails && createVNode("div", {
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createVNode("div", {
        ...
        "icon": icon.value
      }, null, 8, ["icon"]), withDirectives(createVNode("input", mergeProps({
      ...
      }, attrs), null, 16, ["onUpdate:modelValue", "disabled", "id", "onBlur", "onFocus", "readonly", "type", "value", "name", "aria-checked"]), [[vModelDynamic, model.value]]), (_slots$input = slots.input) == null ? void 0 : _slots$input.call(slots, {
        model,
        textColorClasses,
        props: {
          onFocus,
      ...
      })], 4), [[resolveDirective("ripple"), props.ripple && [!props.disabled && !props.readonly, null, ['center', 'circle']]]])]), createVNode(VLabel, {
        "disabled": props.disabled,
        "error": props.error,
        "for": id.value
      }, {
...
const VCheckbox = defineComponent$1({
  name: 'VCheckbox',
  inheritAttrs: false,
  props: {
    ...
    return () => {
      ...
      return isActive.value && withDirectives(createVNode(Tag, {
        ...
        default: () => [genOverlays(isClickable, 'v-chip'), hasPrepend && createVNode("div", {
          ...
          "image": props.prependAvatar,
          "size": props.size
        }, null, 8, ["icon", "image", "size"])]), (_slots$default = (_slots$default2 = slots.default) == null ? void 0 : _slots$default2.call(slots)) != null ? _slots$default : props.text, hasAppend && createVNode("div", {
...
const VCounter = defineComponent$1({
  name: 'VCounter',
  functional: true,
  props: {
    active: Boolean,
    ...
    return () => {
      return createVNode(MaybeTransition, {
        ...
        default: () => [withDirectives(createVNode("div", {
          ...
          max: props.max,
          value: props.value
        }) : counter.value], 512), [[vShow, props.active]])]
      }, 8, ["transition"]);
    };
  }
...
const VDataTableHeaders = defineComponent({
  ...
  setup(props, _ref) {
    return () => {
      return props.rows.map((row, i) => createVNode("tr", {
  ...
  setup(props, _ref) {
    ...
    return () => {
      if (props.showLoader && props.loading) {
        return createRange(props.stopIndex - props.startIndex).map(i => createVNode("tr", {
          "class": "v-data-table__tr",
          "role": "row",
          "key": `loading_${i}`
        }, [props.columns.map(column => createVNode("td", {
      ...
      return props.items.map((item, rowIndex) => item[VDataTableExpandedKey] ? createVNode("tr", {
      ...
      }, [createTextVNode("expanded row")], 4)]) : createVNode("tr", {
        "class": "v-data-table__tr",
        "role": "row",
        "onClick": () => {
...
const VDataTable = defineComponent({
  ...
  setup(props, _ref) {
    ...
    }, null, 8, ["rows", "rowHeight", "sticky"])]), createVNode("tbody", {
      "class": "v-data-table__tbody",
      "role": "rowgroup"
    }, [createVNode(VDataTableRows, {
...
const VVirtualDataTable = defineComponent({
      ...
      return createVNode(Fragment, null, [(_slots$activator = slots.activator) == null ? void 0 : _slots$activator.call(slots, {
        ...
        default: () => [hasContent.value && createVNode("div", mergeProps({
          ...
          default: () => [withDirectives(createVNode("div", {
            ...
            isActive
          })], 6), [[vShow, isActive.value], [resolveDirective("click-outside"), {
...
const VExpansionPanelTitle = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      }, null, 8, ["icon"])])], 14, ["tabindex", "disabled", "aria-expanded", "onClick"]), [[resolveDirective("ripple"), props.ripple]]);
    };
  }
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(VExpandTransition, {
        ...
        }, [(_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots)])], 512), [[vShow, expansionPanel.isSelected.value]])]
      }, 8, ["onAfterLeave"]);
    };
  }
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(props.tag, {
        ...
        default: () => [createVNode("div", {
        ...
        }, null, 2), ((_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots)) || createVNode(Fragment, null, [createVNode(VExpansionPanelTitle, {
          "expandIcon": props.expandIcon,
          "collapseIcon": props.collapseIcon,
          "color": props.color,
          ...
          default: () => [slots.title ? slots.title() : props.title]
        }, 8, ["expandIcon", "collapseIcon", "color", "hideActions", "ripple"]), createVNode(VExpansionPanelText, {
          "eager": props.eager
        }, {
          default: () => [slots.text ? slots.text() : props.text]
        }, 8, ["eager"])])],
...
const VProgressLinear = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => createVNode(props.tag, {
      ...
      }, 8, ["name"]), slots.default && createVNode("div", {
    ...
    useRender(() => {
      ...
      return createVNode(VInput, mergeProps({
        ...
        default: defaultProps => {
          ...
          return createVNode("div", {
          ...
          }, 8, ["active", "color"]), hasPrepend && createVNode("div", {
            "class": "v-field__prepend-inner",
            "onClick": e => emit('click:prepend-inner', e)
          }, [props.prependInnerIcon && createVNode(VIcon, {
            "icon": props.prependInnerIcon
          }, null, 8, ["icon"]), slots == null ? void 0 : (_slots$prependInner = slots.prependInner) == null ? void 0 : _slots$prependInner.call(slots, defaultProps)], 8, ["onClick"]), createVNode("div", {
            "class": "v-field__field"
          }, [['contained', 'filled'].includes(props.variant) && !props.singleLine && createVNode(VFieldLabel, {
            "ref": floatingLabelRef,
            "floating": true
          }, {
            default: () => [label],
            _: 2
          }, 8, ["floating"]), createVNode(VFieldLabel, {
            "ref": labelRef,
            "for": id.value
          }, {
            default: () => [label],
            ...
            }, null, 8, ["icon"])], 8, ["onClick"]), [[vShow, props.dirty]])]
          }), hasAppend && createVNode("div", {
            "class": "v-field__append-inner",
            "onClick": e => emit('click:append-inner', e)
          }, [slots == null ? void 0 : (_slots$appendInner = slots.appendInner) == null ? void 0 : _slots$appendInner.call(slots, defaultProps), props.appendInnerIcon && createVNode(VIcon, {
          ...
          }, [!props.singleLine && createVNode(VFieldLabel, {
            "ref": floatingLabelRef,
            "floating": true
          }, {
            default: () => [label],
          ...
          }, null)]), ['plain', 'underlined'].includes(props.variant) && !props.singleLine && createVNode(VFieldLabel, {
            "ref": floatingLabelRef,
            "floating": true
          }, {
            default: () => [label],
    ...
    useRender(() => {
      ...
      return createVNode(VField, mergeProps({
        ...
        default: _ref3 => {
          ...
          }, slotProps, inputAttrs), null, 16, ["disabled", "multiple", "onClick", "onChange"]), isDirty.value && createVNode("div", {
            "class": fieldClass
  ...
  setup(props, _ref) {
    ...
    return () => {
      return createVNode(VExpandTransition, null, {
        ...
        }, [createVNode(VListChildren, {
          "items": props.items
        }, slots, 8, ["items"])], 4), [[vShow, props.open]])]
      });
    };
  }
  ...
  setup(props, _ref2) {
    ...
    return () => {
      ...
      return createVNode(props.tag, {
        ...
        default: () => [(_slots$header = slots.header) == null ? void 0 : _slots$header.call(slots, headerProps.value), createVNode(VListGroupItems, {
          "items": props.items,
          "open": isOpen.value
        }, slots, 8, ["items", "open"])],
        _: 1
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return withDirectives(createVNode(Tag, {
        ...
        }, 8, ["left"])), hasHeader && createVNode(VListItemHeader, null, {
      ...
      return (_slots$default = (_slots$default2 = slots.default) == null ? void 0 : _slots$default2.call(slots)) != null ? _slots$default : (_props$items = props.items) == null ? void 0 : _props$items.map(_ref2 => {
        ...
        return children ? createVNode(VListGroup, {
          ...
          header: headerProps => slots.header ? slots.header({ ...rest,
            ...headerProps
          }) : createVNode(VListItem, mergeProps(rest, headerProps), null, 16)
        }, 8, ["value", "items"]) : slots.item ? slots.item(item) : createVNode(VListItem, item, slots, 16);
      });
    };
  }
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createVNode(props.tag, {
        ...
        default: () => [hasHeader && (slots.subheader ? slots.subheader() : createVNode(VListSubheader, null, {
...
const VPagination = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => createVNode(props.tag, {
      ...
      }, [slots.first ? slots.first(controls.value.first) : createVNode(VPaginationBtn, controls.value.first, null, 16)]), createVNode("li", {
        "class": "v-pagination__prev",
        "data-test": "v-pagination-prev"
      }, [slots.prev ? slots.prev(controls.value.prev) : createVNode(VPaginationBtn, controls.value.prev, null, 16)]), items.value.map((item, index) => createVNode("li", {
        "key": `${index}_${item.page}`,
        "class": ['v-pagination__item', {
          'v-pagination__item--is-active': item.isActive
        }],
        "data-test": "v-pagination-item"
      }, [slots.item ? slots.item(item) : createVNode(VPaginationBtn, item.props, {
        default: () => [item.page]
      }, 16)], 2)), createVNode("li", {
        "class": "v-pagination__next",
        "data-test": "v-pagination-next"
      }, [slots.next ? slots.next(controls.value.next) : createVNode(VPaginationBtn, controls.value.next, null, 16)]), props.showFirstLastPage && createVNode("li", {
        "class": "v-pagination__last",
        "data-test": "v-pagination-last"
      }, [slots.last ? slots.last(controls.value.last) : createVNode(VPaginationBtn, controls.value.last, null, 16)])])]
      ...
      return createVNode(VInput, mergeProps({
        ...
        default: _ref2 => {
          ...
          return createVNode(Fragment, null, [label && createVNode(VLabel, {
            ...
            default: () => [label],
            _: 2
          }, 8, ["disabled", "error", "for"]), createVNode(VSelectionControlGroup, mergeProps({
            "id": id.value,
            "disabled": isDisabled.value,
            "onIcon": props.onIcon,
  ...
  setup(props, _ref) {
    ...
    function VRatingItem(_ref2) {
      ...
      return createVNode(Fragment, null, [createVNode("label", {
        ...
        value,
        index
      }) : createVNode(VBtn, btnProps, null, 16)], 42, ["for", "onMousedown", "onMouseup", "onMouseenter", "onMouseleave"]), createVNode("input", {
        "class": "v-rating__hidden",
        "name": name.value,
        "id": id,
        "type": "radio",
    ...
    return () => {
      ...
      return createVNode(props.tag, {
        ...
        default: () => [createVNode(VRatingItem, {
          ...
          }, [!hasLabels ? undefined : slots['item-label'] ? slots['item-label']() : (_props$itemLabels2 = props.itemLabels) != null && _props$itemLabels2[i] ? createVNode("span", null, [(_props$itemLabels3 = props.itemLabels) == null ? void 0 : _props$itemLabels3[i]]) : createVNode("span", null, [createTextVNode("\xA0")]), createVNode("div", {
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(props.tag, {
        ...
        }, [createVNode("table", null, [(_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots)])], 4), (_slots$bottom = slots.bottom) == null ? void 0 : _slots$bottom.call(slots)],
        _: 1
      }, 8, ["class"]);
    };
  }
    ...
    useRender(() => {
      ...
      return createVNode(VField, mergeProps({
        ...
        default: _ref2 => {
          ...
          return createVNode(Fragment, null, [props.prefix && createVNode("span", {
          ...
          }, [props.prefix], 4), withDirectives(createVNode("textarea", mergeProps({
            "class": fieldClass,
            "style": {
              opacity: showPlaceholder ? undefined : '0'
            },
            ...
            "rows": props.rows
          }, slotProps, inputAttrs), null, 16, ["onUpdate:modelValue", "autofocus", "readonly", "disabled", "placeholder", "rows"]), [[vModelText, model.value], [resolveDirective("intersect"), {
            handler: onIntersect
          }, null, {
            once: true
            ...
            "readonly": true,
            "aria-hidden": "true"
          }, null, 10, ["onUpdate:modelValue", "readonly"]), [[vModelText, model.value]]), props.suffix && createVNode("span", {
        ...
        details: hasCounter ? _ref3 => {
          ...
          return createVNode(Fragment, null, [createVNode("span", null, null), createVNode(VCounter, {
    ...
    useRender(() => {
      ...
      return createVNode(VField, mergeProps({
        ...
        default: _ref2 => {
          ...
          return createVNode(Fragment, null, [props.prefix && createVNode("span", {
          ...
          }, [props.prefix], 4), withDirectives(createVNode("input", mergeProps({
            "class": fieldClass,
            "style": {
              opacity: showPlaceholder ? undefined : '0'
            },
            ...
            "size": 1,
            "type": props.type
          }, slotProps, inputAttrs), null, 16, ["onUpdate:modelValue", "autofocus", "readonly", "disabled", "placeholder", "type"]), [[vModelDynamic, model.value], [resolveDirective("intersect"), {
            handler: onIntersect
          }, null, {
            once: true
...
const VTimelineDivider = defineComponent$1({
  ...
  setup(props, _ref) {
    ...
    return () => createVNode("div", {
      ...
      "size": props.size
    }, null, 8, ["icon", "color", "size"]) : undefined], 6)], 6), createVNode("div", {
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "style": dimensionStyles.value
      }, [(_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots)], 4), createVNode(VTimelineDivider, {
        "ref": dotRef,
...
var components = /*#__PURE__*/Object.freeze({
  ...
  VVirtualDataTable: VVirtualDataTable,
