...
declare type DataTableHeader$1 = {
    id: string;
    name: string;
    colspan?: number;
    rowspan?: number;
...
declare const VDataTable: vue.DefineComponent<{
    headers: {
        type: PropType<DataTableHeader$1[] | DataTableHeader$1[][]>;
        required: true;
    };
    items: {
        type: PropType<any[]>;
    ...
    headers: DataTableHeader$1[] | DataTableHeader$1[][];
...
declare const VVirtualDataTable: vue.DefineComponent<{
    headers: {
    ...
    showLoader: BooleanConstructor;
    itemsLength: NumberConstructor;
}, () => JSX.Element, unknown, {}, {}, vue.ComponentOptionsMixin, vue.ComponentOptionsMixin, {
...
export { VAlert, VApp, VAppBar, VAppBarNavIcon, VAppBarTitle, VAvatar, VBadge, VBanner, VBannerActions, VBannerAvatar, VBannerContent, VBannerText, VBottomNavigation, VBreadcrumbs, VBreadcrumbsDivider, VBreadcrumbsItem, VBtn, VBtnGroup, VCard, VCardActions, VCardAvatar, VCardHeader, VCardHeaderText, VCardImg, VCardSubtitle, VCardText, VCardTitle, VCarouselReverseTransition, VCarouselTransition, VCheckbox, VChip, VClassIcon, VCode, VCol, VComponentIcon, VContainer, VCounter, VDataTable, VDefaultsProvider, VDialog, VDialogBottomTransition, VDialogTopTransition, VDialogTransition, VDivider, VExpandTransition, VExpandXTransition, VExpansionPanel, VExpansionPanelText, VExpansionPanelTitle, VExpansionPanels, VFabTransition, VFadeTransition, VField, VFieldLabel, VFileInput, VFooter, VForm, VHover, VIcon, VImg, VInput, VItem, VItemGroup, VKbd, VLabel, VLayout, VLayoutItem, VLazy, VLigatureIcon, VList, VListGroup, VListImg, VListItem, VListItemAvatar, VListItemHeader, VListItemMedia, VListItemSubtitle, VListItemTitle, VListSubheader, VLocaleProvider, VMain, VMenu, VMenuTransition, VMessages, VNavigationDrawer, VNoSsr, VOverlay, VPagination, VPaginationBtn, VParallax, VProgressCircular, VProgressLinear, VRadio, VRadioGroup, VRating, VResponsive, VRow, VScaleTransition, VScrollXReverseTransition, VScrollXTransition, VScrollYReverseTransition, VScrollYTransition, VSelectionControl, VSelectionControlGroup, VSheet, VSlideXReverseTransition, VSlideXTransition, VSlideYReverseTransition, VSlideYTransition, VSpacer, VSvgIcon, VSwitch, VSystemBar, VTabReverseTransition, VTabTransition, VTable, VTextField, VTextarea, VThemeProvider, VTimeline, VTimelineItem, VTooltip, VValidation, VVirtualDataTable };
